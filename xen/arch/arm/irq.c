 ...
 * CONFIG_GICV3_ESPI=n. Without CONFIG_GICV3_ESPI, the additional 1024
 * IRQ descriptors will not be defined, and thus, they cannot be used.
 * Unless INTIDs from the eSPI range are mistakenly defined in Xen DTS
 * when the appropriate config is disabled, this function will not be
 * reached because is_espi will return false for non-eSPI INTIDs.
 */
